...
public class LoadPicAdapter extends RecyclerView.Adapter<LoadPicAdapter.MyViewHolder> {
     ...
     public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
         ...
         //这里要改
         view = LayoutInflater.from(context).inflate(R.layout.add_image_item, parent, false);
     ...
     public void onBindViewHolder(MyViewHolder holder, final int position) {
         ...
         if (position == 0&&fileList.get(position).getBitmap()==null) {
             holder.ivPic.setImageResource(R.drawable.add_image);//加号图片
